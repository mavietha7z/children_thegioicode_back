...
const serviceFetchLoginVngGames = async (url, data, apikey) => {
    try {
        ...
        configCreateLog('services/v2/vnggames.log', 'serviceFetchLoginVngGames', error.message);
        return { success: false, status: 400, error: 'Lỗi đăng nhập vui lòng thử lại' };
    }
};

export { serviceFetchLoginVngGames };
